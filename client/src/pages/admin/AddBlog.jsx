...
const AddBlog = () => {
    ...
    const [catergory, setCategory] = useState('Startup');
    ...
    <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
      ...
      <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
        ...
        {loading && (
            ...
            <button disabled={loading} type='button' onClick={generateContent} className='absolute bottom-1 right-0 mr-2 text-xs text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer'>Generate with AI</button>
      ...
      <button disabled={isAdding} type='submit' className='mt-8 w-40 h-10 bg-[#5044E4] text-white rounded cursor-pointer text-sm'>{isAdding?'Adding..' : 'Add Blog'}</button>
