    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 '>
          <div className='text-center mt-20 mb-8'>
            <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-[#5044E4]/40 bg-[#5044E4]/10 rounded-full text-sm text-[#5044E4]'>
          ...
          <div className='text-center'>
            {input && 
            <button onClick={onClear} className='border font-light test-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer'>Clear Search</button>
            }
          </div>
